...
copia_superficiale = ...  # usa copy()
copia_profonda = ...  # usa copy.deepcopy()
...
numeri_decrescenti_2 = sorted(numeri_reverse, reverse=...)
...
e_vuota_1 = len(lista_vuota) == ...
e_vuota_2 = len(lista_piena) == ...
