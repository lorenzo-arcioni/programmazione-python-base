...
numeri_unici = set(numeri_duplicati)  # converti in set per rimuovere duplicati

# Esercizio 3: Conversione da stringa a set di caratteri
parola = "programmazione"
caratteri_unici = set(parola)  # converti la stringa in set di caratteri
...
ha_python = "Python" in linguaggi  # verifica se "Python" è nel set
ha_ruby = "Ruby" in linguaggi  # verifica se "Ruby" è nel set

# Esercizio 8: Unione di set con operatore |
set1 = {1, 2, 3}
set2 = {3, 4, 5}
set_unione = set1 | set2  # unisci i due set
...
mammiferi_domestici = animali_domestici & animali_mammiferi  # trova l'intersezione

# Esercizio 10: Differenza di set con operatore -
tutti_numeri = {1, 2, 3, 4, 5, 6}
numeri_pari = {2, 4, 6}
numeri_dispari = tutti_numeri - numeri_pari  # trova i numeri dispari (differenza)
...
solo_una_materia = studenti_matematica ^ studenti_fisica  # studenti che seguono solo una delle due materie

# Esercizio 12: Aggiornamento in-place con update()
base_set = {1, 2, 3}
nuovo_set = {4, 5, 6}
# Aggiungi gli elementi di nuovo_set a base_set usando update()
base_set.update(nuovo_set)

# Esercizio 13: Copia di un set
originale = {"a", "b", "c"}
copia_set = originale.copy()  # crea una copia usando copy()

# Esercizio 14: Confronto di uguaglianza tra set
set_a = {1, 2, 3}
set_b = {3, 2, 1}
sono_uguali = set_a == set_b  # verifica se i due set sono uguali

# Esercizio 15: Verifica di sottoinsieme con <=
piccolo_set = {1, 2}
grande_set = {1, 2, 3, 4, 5}
e_sottoinsieme = piccolo_set <= grande_set  # verifica se piccolo_set è sottoinsieme di grande_set

# Esercizio 16: Verifica di sovrainsieme con >=
gruppo_completo = {"admin", "user", "guest", "moderator"}
gruppo_base = {"user", "guest"}
e_sovrainsieme = gruppo_completo >= gruppo_base  # verifica se gruppo_completo è sovrainsieme di gruppo_base

# Esercizio 17: Verifica di disgiunzione con isdisjoint()
set_pari = {2, 4, 6, 8}
set_dispari = {1, 3, 5, 7}
sono_disgiunti = set_pari.isdisjoint(set_dispari)  # verifica se i due set non hanno elementi comuni
...
frozen_numeri = frozenset(lista_immutabile)  # crea un frozenset dalla lista

# Esercizio 20: Lunghezza di un set
vocali = {"a", "e", "i", "o", "u"}
numero_vocali = len(vocali)  # trova la lunghezza del set