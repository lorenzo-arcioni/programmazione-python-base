...
persona = {"età": 30, "nome": "Anna", "sposato": True}

# Esercizio 2: Accesso diretto ai valori con []
studente = {"nome": "Marco", "età": 20, "corso": "Informatica", "voto": 28}
nome_studente = studente["nome"]  # accesso al nome
voto_studente = studente["voto"]  # accesso al voto

# Esercizio 3: Accesso sicuro con get()
prodotto = {"nome": "Laptop", "prezzo": 899.99, "categoria": "Elettronica"}
prezzo_prodotto = prodotto.get("prezzo")  # usa get() per ottenere il prezzo
sconto = prodotto.get("sconto", 0)  # usa get() per ottenere "sconto" con valore di default 0
...
porta = configurazione.setdefault("porta", 8080)
...
punteggio_bob = punteggi.pop("Bob")
...
base_config.update(nuova_config)

# Esercizio 10: Unione di dizionari con unpacking
dict1 = {"a": 1, "b": 2}
dict2 = {"c": 3, "d": 4}
dict_unito = {**dict1, **dict2}  # unisci i due dizionari usando unpacking

# Esercizio 11: Controllo presenza chiave con in
menu = {"pizza": 12.50, "pasta": 9.00, "insalata": 7.50, "dolce": 5.00}
ha_pizza = "pizza" in menu  # verifica se "pizza" è nel menu
ha_sushi = "sushi" in menu  # verifica se "sushi" è nel menu

# Esercizio 12: Ottenere le chiavi con keys()
temperatura = {"lunedì": 22, "martedì": 25, "mercoledì": 20, "giovedì": 23}
giorni = list(temperatura.keys())  # ottieni tutte le chiavi (convertile in lista)

# Esercizio 13: Ottenere i valori con values()
prezzi = {"caffè": 1.50, "cappuccino": 2.00, "cornetto": 1.20}
tutti_prezzi = list(prezzi.values())  # ottieni tutti i valori (convertili in lista)
...
copia_dict = originale.copy()  # crea una copia usando copy()

# Esercizio 16: Creazione con fromkeys()
chiavi_default = ["rosso", "verde", "blu"]
colori_dict = dict.fromkeys(chiavi_default, 0)  # crea dizionario con tutte chiavi che hanno valore 0
...
insegnante_1A = scuola["classe_1A"]["insegnante"]  # accedi all'insegnante della classe 1A
studenti_2B = scuola["classe_2B"]["studenti"]  # accedi al numero di studenti della classe 2B

# Esercizio 19: Conversione da lista di tuple a dizionario
lista_coppie = [("nome", "Luigi"), ("età", 25), ("città", "Roma")]
dict_da_lista = dict(lista_coppie)  # converti la lista di tuple in dizionario
