...
lista_invertita = ...  # tutta la lista al contrario
...
lista1 = [1, 2, 3]
lista2 = [4, 5, 6]
lista_concatenata = ...  # unisci le due liste
...
# Nota: i numeri che sono alla fine del nome delle variabili si riferiscono all'esercizio
# Es: lista_originale_11 significa lista originale dell'esercizio 11

# Esercizio 11: Ripetizione di liste

pattern_11 = [0, 1]
lista_ripetuta_11 = ...  # ripeti il pattern 4 volte

# Esercizio 12: Verifica di appartenenza con in

linguaggi_12 = ["Python", "Java", "C++", "JavaScript"]
ha_python_12 = ...  # verifica se "Python" è nella lista
ha_ruby_12 = ...  # verifica se "Ruby" è nella lista
...
elemento_centrale_20 = ...  # accedi all'elemento 5 (centro della matrice)
prima_riga_20 = ...  # accedi alla prima riga completa